...
int main(void)
{
	...
	TEST_MATCH("abc123", "abc.*");
	TEST_MATCH("abc123def", "abc.*");
	TEST_MATCH("abc123", "abc.*def");
	TEST_MATCH("abc123def", "abc.*def");
	TEST_MATCH("abc123def456", "abc.*def.*");
	TEST_MATCH("abc123def456def", "abc.*def");
